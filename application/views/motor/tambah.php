                ...
                <div class="card-body">
                    <form action="" method="post">
                        <div class="form-group">
                            <label for="nama_motor">Nama_Motor</label>
                            <input type="text" name="nama_motor" class="form-control" id="nama_motor">
                        ...
                        <button type="submit" name="tambah" class="btn btn-primary float-right"><img src="https://img.icons8.com/ios-glyphs/30/000000/add-property.png"/></button>
                    </form>
                </div>
            </div>
